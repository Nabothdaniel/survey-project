...
const SurveyPage: React.FC = () => {
    ...
    const survey = surveyData.find((s) => s.id === selectedSurvey);
    const currentAnswers = survey ? userSurveys[survey.id]?.answers || {} : {};
    ...
    const handleChange = (questionId: number, value: string) => {
        ...
        setUserSurveys((prev) => ({
            ...
            [survey.id]: {
                status: "in_progress",
                answers: { ...currentAnswers, [questionId]: value },
            },
        }));
    };
            ...
            {!survey ? (
                <div className="bg-white rounded-lg shadow border border-gray-200">
                    ...
                    <div className="divide-y divide-gray-200">
                        {surveyData.map((s) => {
                            const state: SurveyStatus = userSurveys[s.id]?.status || "new";
                            return (
                                <div
                                    key={s.id}
